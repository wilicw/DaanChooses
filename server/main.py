...
api.add_resource(resources.Clubs, "/api/clubs", "/api/clubs/",
                 "/api/clubs/<string:id>")
api.add_resource(resources.Users, "/api/user")
api.add_resource(resources.Chooses, "/api/chooses")

api.add_resource(resources.GetNotChoosesFile,
                 "/api/file/notchooses/<string:token>")
api.add_resource(resources.GetAllStudentsFile,
                 "/api/file/allstudents/<string:token>")
